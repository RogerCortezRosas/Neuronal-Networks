...
for data in data_json:
  ...
  #BytesIO() BytesIO(response.content) crea un "archivo virtual en memoria" a partir de esos bytes. Es como si tuviéramos el archivo de la imagen en lugar de tenerlo en el disco.
